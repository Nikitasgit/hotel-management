...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  const remainingPhotosCount = totalPhotos - 5;
  return (
    <div className="container mx-auto">
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        <div className="h-[540px] relative rounded-2xl overflow-hidden">
          ...
          <div className="md:hidden flex justify-center items-center w-full h-full cursor-pointer">
            <Image
              ...
              width={800}
              height={800}
              onClick={openModal.bind(this, currentPhotoIndex)}
            />
          </div>
        </div>
        ...
        {showModal && (
          <div className="select-none fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-90 z-[55]">
